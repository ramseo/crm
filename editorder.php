...
//echo $sql;exit;
        ...
        <table class="table" id="productTable">
          ...
          <tbody>
            ...
            $orderItemSql = "SELECT order_item.id, order_item.order_id, order_item.productName, order_item.rate, order_item.total FROM order_item WHERE order_item.order_id = {$orderId}";
