        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Import Business Type</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">>Import Business Type</li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="input-states">
                                   <form class="form-horizontal" id="submitImportForm" action="php_action/createBrandImport.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Import Business Type FIle</label>
                                                
                                                <div class="col-sm-9">
                                                 <input type="file" class="form-control" id="brandfile" placeholder="Import Business Type" name="brandfile" class="file-loading" style="width:auto;"/>
